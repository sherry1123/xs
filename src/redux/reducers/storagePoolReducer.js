...
const storagePoolReducer = (state = State.main.storagePool, action) => {
    let {storagePoolList, dataClassificationList, targetsOfStoragePool, buddyGroupsOfStoragePool, targetsForStoragePool, buddyGroupsForStoragePool, groupQuotasOfStoragePool} = action;
    switch (action.type){
