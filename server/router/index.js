...
router.all('/api/getlocalusergroup', controller['/api/getlocalusergroup']);
router.all('/api/createlocalusergroup', controller['/api/createlocalusergroup']);
router.all('/api/updatelocalusergroup', controller['/api/updatelocalusergroup']);
router.all('/api/deletelocalusergroup', controller['/api/deletelocalusergroup']);
router.all('/api/getlocaluser', controller['/api/getlocaluser']);
router.all('/api/createlocaluser', controller['/api/createlocaluser']);
router.all('/api/updatelocaluser', controller['/api/updatelocaluser']);
router.all('/api/deletelocaluser', controller['/api/deletelocaluser']);
